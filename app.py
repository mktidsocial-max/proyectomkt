...
# --- CREDENCIALES MAESTRAS (La combinación más segura) ---
# Usamos tu MASTER KEY (La llave suprema que abre todo)
...
def get_db():
    ...
    # IMPORTANTE: Aquí usamos X-Master-Key
        ...
        if req.status_code == 200:
            ...
            return {
                ...
                "logs": [{
                    ...
                    "accion": f"⚠️ ERROR {req.status_code}: La Master Key no pudo abrir el Bin {JSONBIN_BIN_ID[:5]}..."
                }]
            }
